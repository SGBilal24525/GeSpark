...
const conversionFactors: Record<string, Record<string, number>> = {
    'currency': { 'USD-PKR': 280.25, 'PKR-USD': 1/280.25, 'USD-INR': 83.3, 'INR-USD': 1/83.3, 'USD-EUR': 0.92, 'EUR-USD': 1/0.92, 'USD-GBP': 0.79, 'GBP-USD': 1/0.79, 'USD-JPY': 150.5, 'JPY-USD': 1/150.5, 'PKR-INR': 0.29, 'INR-PKR': 1/0.29, },
};
...
export function CurrencyConverter({ tool }: { tool: Tool }) {
                ...
                <Card>
                    ...
                    <CardContent className="space-y-6">
                        <div className="space-y-2">
                            ...
                            <Input id="converterValue" type="number" value={converterValue === undefined ? '' : converterValue} onChange={e => setConverterValue(e.target.value === '' ? undefined : parseFloat(e.target.value))} placeholder="e.g., 10" />
                        </div>
